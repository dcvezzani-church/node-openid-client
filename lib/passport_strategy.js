...
OpenIDConnectStrategy.prototype.authenticate = function authenticate(req, options) {
  (async () => {
    ...
    if (Object.keys(reqParams).length === 0) {
      ...
      const params = {
        /*
         * MODIFIED from original code (original: https://github.com/panva/node-openid-client)
         * Instead of using a traditional uuid value for state, to preserve stateful values,
         * allow for more complex state values
         */
        state: JSON.stringify({state: random(), returnTo: req.session.returnTo}),
        ...this._params,
        ...options,
      };
